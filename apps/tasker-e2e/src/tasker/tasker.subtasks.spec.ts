import { generateCreateSubtaskDto } from '@tasker/shared';
...
describe('Sub tasks e2e tests', () => {
  ...
  describe('PUT /subtasks/:id', () => {
    it('should update subtask', async () => {
      ...
      const updateSubtaskData = generateCreateSubtaskDto();
